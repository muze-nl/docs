...
MetroJS is a javascript library containing an HTTPS client with support for middleware. The OpenID Connect middleware for MetroJS allows you to configure a [metro client](https://github.com/muze-nl/metro) to handle authorization and authentication using OpenID Connect:

OpenID Connect is a protocol that simplifies user verification and profile information exchange across web-based, mobile, and JavaScript clients.
